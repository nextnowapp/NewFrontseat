...
class ContentListHome extends StatefulWidget {
  var _titles;
  var _images;

  ContentListHome(this._titles, this._images);

  @override
  _HomeState createState() => _HomeState(_titles, _images);
}

class _HomeState extends State<ContentListHome> {
  bool? isTapped;
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                return CustomWidget(
                  ...
                  element:
                      AppFunction.getContentListHome(context, _titles[index]),
