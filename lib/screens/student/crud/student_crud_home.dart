...
class StudentCrudHomeScreen extends StatefulWidget {
  var _titles;
  var _images;

  StudentCrudHomeScreen(this._titles, this._images);

  @override
  _HomeState createState() => _HomeState(_titles, _images);
}

class _HomeState extends State<StudentCrudHomeScreen> {
  bool? isTapped;
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                return CustomWidget(
                  ...
                  element: AppFunction.getLearnerCrudDashboardPage(
