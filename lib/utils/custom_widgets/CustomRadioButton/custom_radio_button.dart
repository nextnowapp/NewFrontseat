...
class _CustomRadioButtonState extends State<CustomRadioButton> {
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      color:
                          (_currentSelectedLabel == widget.buttonLables[index])
                              ? getSelectedColor(widget.buttonLables[index])
                              : widget.buttonTextStyle.unSelectedColor),
                ),
                const SizedBox(
                  width: 8,
  ...
  Color getSelectedColor(String label) {
    switch (label) {
      case 'Present':
        {
          return HexColor('#4fbe9e');
        }
        break;
      case 'Absent':
        {
          return HexColor('#f22742');
        }
        break;
      case 'Late':
        {
          return HexColor('#fec233');
        }
    }
    return HexColor('#8395ae');
  }
}
