    ...
    on<UploadPersonalDataEvent>((event, emit) async {
      ...
      try {
        var data = {
          ...
          'residentialUnitNo': event.residentialUnit,
          'residentialComplexName': event.residentialComplex,
          'residentialStreetNo': event.residentialStreet,
          'residentialSuburb': event.residentialSuburb,
          ...
          'postalUnitNo': event.postalUnit,
          'postalComplexName': event.postalComplex,
          'postalStreetNo': event.postalStreet,
          'postalSuburb': event.postalSuburb,
