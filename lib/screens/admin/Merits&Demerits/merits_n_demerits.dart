...
class MeritsNDemerits extends StatefulWidget {
  var _titles;
  var _images;

  MeritsNDemerits(this._titles, this._images);

  @override
  _HomeState createState() => _HomeState(_titles, _images);
}

class _HomeState extends State<MeritsNDemerits> {
  bool? isTapped;
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                return CustomWidget(
                  ...
                  element: AppFunction.getMeritNDemeritDashboard(
