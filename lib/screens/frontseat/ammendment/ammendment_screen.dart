...
class AmmendementScreen extends StatefulWidget {
  const AmmendementScreen({Key? key}) : super(key: key);

  @override
  State<AmmendementScreen> createState() => _AmmendmentScreenState();
}

class _AmmendmentScreenState extends State<AmmendementScreen> {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Text(
              'Application amendment will put your profile on hold .',
