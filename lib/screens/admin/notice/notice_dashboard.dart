...
class SchoolNoticeHomeScreen extends StatefulWidget {
  final _titles;
  final _images;

  SchoolNoticeHomeScreen(this._titles, this._images);

  @override
  _HomeState createState() => _HomeState(_titles, _images);
}

class _HomeState extends State<SchoolNoticeHomeScreen> {
  bool? isTapped;
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              return CustomWidget(
                ...
                element:
                    AppFunction.getNoticeDashboardPage(context, _titles[index]),
