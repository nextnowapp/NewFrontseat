...
class _TeacherScreenState extends State<TeacherScreen> {
  ...
  AttendanceStatController _attendanceStatController = Get.put(
  ...
  void initState() {
    ...
    _future = InfixApi.getTeacherInfo(
      id,
      token,
    );
    super.initState();
        ...
        builder: (BuildContext context, AsyncSnapshot<ProfileModel> snapshot) {
          if (snapshot.hasData) {
            _selectedClass = snapshot.data!.data!.userDetails!.className ??
                'No Class Assigned';
            _selectedClassId = snapshot.data!.data!.userDetails!.classId;
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    snapshot
                                        .data!.data!.userDetails!.designation!,
                                    maxLines: 2,
                                    style: TextStyle(
                                      fontFamily: GoogleFonts.inter(
                                              fontWeight: FontWeight.w600)
            ...
            try {
              ...
              Dio()
                ...
                if (response.statusCode == 200) {
                  var jsonData = response.data;
                  if (jsonData['success'] == true) {
                    await _attendanceStatController.fetchAttendanceStat();
                    Utils.showThemeToast(
                      jsonData['message'],
                    );
                  }
